				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<select name="status" id="" class="select custom-select custom-select-sm">
									     <option value="1" <?php if($status=='1') echo 'selected';?>>Presently</option>
										 <option value="0" <?php if($status=='0') echo 'selected';?>>Completed</option>
							</select>
						</div>
					</div>
				</div>
